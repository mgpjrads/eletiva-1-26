...
-- Schema gestao_projetos
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `gestao_projetos` DEFAULT CHARACTER SET utf8 ;
USE `gestao_projetos` ;

-- -----------------------------------------------------
-- Table `gestao_projetos`.`projetos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestao_projetos`.`projetos` (
...
-- -----------------------------------------------------
-- Table `gestao_projetos`.`membros`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestao_projetos`.`membros` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(255) NOT NULL,
...
-- -----------------------------------------------------
-- Table `gestao_projetos`.`tarefas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestao_projetos`.`tarefas` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `gestao_projetos`.`atividades`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestao_projetos`.`atividades` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_atividades_projetos`
    ...
    REFERENCES `gestao_projetos`.`projetos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_atividades_tarefas1`
    FOREIGN KEY (`tarefas_id`)
    REFERENCES `gestao_projetos`.`tarefas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_atividades_membros1`
    FOREIGN KEY (`membros_id`)
    REFERENCES `gestao_projetos`.`membros` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
